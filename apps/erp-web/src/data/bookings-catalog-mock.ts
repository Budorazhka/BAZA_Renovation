...
export const NEW_BUILD_COMPLEXES_MOCK: NewBuildComplex[] = [
  ...
  { id: 'rc-zarechye', name: 'ЖК Заречье Парк', developerName: 'А101' },
]
...
export const NEW_BUILD_APARTMENTS_MOCK: NewBuildApartment[] = [
  ...
  { id: 'apt-zr-1', rcId: 'rc-zarechye', label: 'корп. 5, кв. 102', typology: '1к, 42 м²', salesStatus: 'free' },
  { id: 'apt-zr-2', rcId: 'rc-zarechye', label: 'корп. 5, кв. 215', typology: '2к, 64 м²', salesStatus: 'free' },
  { id: 'apt-zr-3', rcId: 'rc-zarechye', label: 'корп. 6, кв. 33', typology: 'Студия, 26 м²', salesStatus: 'reserved' },
]
