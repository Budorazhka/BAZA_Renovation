...
export function StatCard({
  ...
  const cardContent = (
    <div className={cn('flex h-full min-h-[62px] flex-col items-center justify-center gap-1 text-center', className)}>
      ...
      <div className="truncate text-[28px] font-normal leading-none tracking-tight text-slate-900 sm:text-[30px]">
      ...
      <Tooltip delayDuration={100}>
        ...
        >
          <div className="mb-1.5 flex items-center justify-center border-b border-slate-200 pb-1.5">
            <span className={cn('inline-flex items-center gap-1.5 text-[22px] font-normal leading-none', trendTextColor)}>
