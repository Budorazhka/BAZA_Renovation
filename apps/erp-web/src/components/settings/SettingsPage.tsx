...
import { User, Building2, Bell, Settings, Users, CreditCard, ShieldCheck, Paintbrush, MessageCircle } from 'lucide-react'
...
export function SettingsPage({ initialSection }: SettingsPageProps) {
  ...
  const allItems: (NavItem & { visible: boolean })[] = [
    ...
    { id: 'chats',         label: 'Настройки чата',     icon: <MessageCircle className="size-4" />,visible: true, separator: true },
  ...
  return (
    <div className="min-h-screen bg-[var(--app-bg)] text-[var(--app-text)]">
      <div className="relative z-10 p-6 lg:p-8">
        ...
        {/* Header */}
        <div className="mb-8">
          <p className="text-xs uppercase tracking-widest text-[color:var(--hub-stat-label)] mb-1">{t('settings.settingsPage.управление')}</p>
          <h1 className="text-3xl font-normal text-[color:var(--app-text)]">{t('settings.settingsPage.настройки')}</h1>
        </div>
        ...
        <div className="flex gap-8 items-start">
          ...
          <div className="flex-1 min-w-0">
            ...
            {resolvedSection === 'chats'         && <ChatSettingsTab />}
