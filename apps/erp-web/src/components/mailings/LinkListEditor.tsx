  ...
  return (
    <div className={cn('space-y-3', className)}>
      <div className="flex items-center justify-between">
        <Label className="text-base text-[color:var(--app-text-muted)]">{t('mailings.linkListEditor.ссылки')}</Label>
        <Button
          type="button"
          variant="outline"
          size="sm"
        ...
        >
          ...
          {t('mailings.linkListEditor.добавить_ссылку')}</Button>
      </div>
        ...
        >
          ...
          <div className="min-w-0 flex-1 space-y-1">
            <div className="flex items-center gap-1.5">
              <Label className="text-sm text-[color:var(--app-text-muted)]">{t('mailings.linkListEditor.текст_ссылки_опциона')}</Label>
              <Tooltip>
                ...
                >
                  {t('mailings.linkListEditor.анкор_это_видимый_те')}</TooltipContent>
              </Tooltip>
            </div>
            <Input
              placeholder={t('mailings.linkListEditor.анкор')}
              value={link.label ?? ''}
          ...
          <Button
            ...
            title={t('mailings.linkListEditor.удалить')}
          >
