    ...
    <DashboardShell>
      <div className="min-h-0 flex-1 overflow-y-auto p-6">
        <div className="mx-auto w-full max-w-6xl space-y-4">
          <div>
            <h1 className="text-xl font-normal text-[color:var(--theme-accent-heading)]">{t('newbuild.newBuildingsPartnersPage.партн_ры_первичного')}</h1>
            <p className="mt-1 text-sm text-[color:var(--app-text-muted)]">
              {t('newbuild.newBuildingsPartnersPage.реестр_партн_ров_кон')}</p>
          </div>
          ...
          <section className="rounded-lg border border-[var(--hub-card-border)] bg-[var(--hub-card-bg)] p-3">
            <div className="mb-3 flex items-center gap-2">
              ...
              <h2 className="text-sm font-normal text-[color:var(--theme-accent-heading)]">{t('newbuild.newBuildingsPartnersPage.фильтры')}</h2>
            </div>
            <div className="grid grid-cols-1 gap-2 md:grid-cols-3">
              ...
              >
                <option value="all">{t('newbuild.newBuildingsPartnersPage.сегмент_все')}</option>
                <option value="Агентство">{t('newbuild.newBuildingsPartnersPage.агентство')}</option>
                <option value="Брокер">{t('newbuild.newBuildingsPartnersPage.брокер')}</option>
                <option value="Корпоративный партнёр">{t('newbuild.newBuildingsPartnersPage.корпоративный_партн')}</option>
              </select>
              <select
                value={city}
                ...
                className="rounded-md border border-[var(--workspace-row-border)] bg-[var(--workspace-row-bg)] px-2 py-2 text-sm text-[color:var(--workspace-text)]"
              >
                <option value="all">{t('newbuild.newBuildingsPartnersPage.город_все')}</option>
                {cityOptions.map((c) => (
              ...
              <label className="flex cursor-pointer items-center gap-2 rounded-md border border-[var(--workspace-row-border)] bg-[var(--workspace-row-bg)] px-2 py-2 text-sm text-[color:var(--workspace-text)]">
                ...
                {t('newbuild.newBuildingsPartnersPage.слабые_по_сделкам_ин')}</label>
            </div>
          </section>

          <section className="grid grid-cols-2 gap-2 md:grid-cols-5">
            <div className="rounded-lg border border-[var(--hub-card-border)] bg-[var(--hub-card-bg)] p-3">
              <p className="text-[10px] uppercase tracking-wide text-[color:var(--app-text-subtle)]">{t('newbuild.newBuildingsPartnersPage.в_выборке')}</p>
              <p className="text-xl font-normal text-[color:var(--theme-accent-heading)]">{kpi.n}</p>
            </div>
            <div className="rounded-lg border border-[var(--hub-card-border)] bg-[var(--hub-card-bg)] p-3">
              <p className="text-[10px] uppercase tracking-wide text-[color:var(--app-text-subtle)]">{t('newbuild.newBuildingsPartnersPage.сделок_ytd')}</p>
              <p className="text-xl font-normal text-emerald-400">{kpi.deals}</p>
            </div>
            <div className="rounded-lg border border-[var(--hub-card-border)] bg-[var(--hub-card-bg)] p-3">
              <p className="text-[10px] uppercase tracking-wide text-[color:var(--app-text-subtle)]">{t('newbuild.newBuildingsPartnersPage.регистраций_ytd')}</p>
              <p className="text-xl font-normal text-blue-400">{kpi.reg}</p>
            </div>
            <div className="rounded-lg border border-[var(--hub-card-border)] bg-[var(--hub-card-bg)] p-3">
              <p className="text-[10px] uppercase tracking-wide text-[color:var(--app-text-subtle)]">{t('newbuild.newBuildingsPartnersPage.ср_индекс')}</p>
              <p className="text-xl font-normal text-[color:var(--workspace-text)]">{kpi.avgHealth}</p>
            </div>
            <div className="rounded-lg border border-[var(--hub-card-border)] bg-[var(--hub-card-bg)] p-3">
              <p className="text-[10px] uppercase tracking-wide text-[color:var(--app-text-subtle)]">{t('newbuild.newBuildingsPartnersPage.проектов_в_сети')}</p>
              <p className="text-xl font-normal text-amber-300">{kpi.projects}</p>
            </div>
          </section>
          ...
          <div className="grid min-h-[440px] grid-cols-1 gap-3 lg:grid-cols-[1.15fr_1fr]">
            <section className="rounded-lg border border-[var(--hub-card-border)] bg-[var(--hub-card-bg)] p-3">
              <div className="mb-2 flex items-center gap-2">
                ...
                <h2 className="text-sm font-normal text-[color:var(--theme-accent-heading)]">{t('newbuild.newBuildingsPartnersPage.реестр_партн_ров')}</h2>
              </div>
                ...
                <table className="w-full min-w-[520px] border-collapse text-sm">
                  <thead>
                    <tr className="border-b border-[color:var(--workspace-row-border)] text-left text-[11px] uppercase tracking-wide text-[color:var(--app-text-subtle)]">
                      <th className="px-2 py-2">{t('newbuild.newBuildingsPartnersPage.партн_р')}</th>
                      <th className="px-2 py-2">{t('newbuild.newBuildingsPartnersPage.город')}</th>
                      <th className="px-2 py-2">{t('newbuild.newBuildingsPartnersPage.сделки')}</th>
                      <th className="px-2 py-2">{t('newbuild.newBuildingsPartnersPage.индекс')}</th>
                    </tr>
                  </thead>
                  <tbody>
                      ...
                      return (
                        ...
                        >
                          <td className="px-2 py-2">
                            <p className="font-normal text-[color:var(--workspace-text)]">{partner.name}</p>
            ...
            <section className="rounded-lg border border-[var(--hub-card-border)] bg-[var(--hub-card-bg)] p-3">
              <div className="mb-2 flex items-center gap-2">
                ...
                <h2 className="text-sm font-normal text-[color:var(--theme-accent-heading)]">{t('newbuild.newBuildingsPartnersPage.карточка_партн_ра')}</h2>
              </div>
              {active ? (
                <div className="space-y-3">
                  <div className="rounded-md border border-[color:var(--workspace-row-border)] bg-[var(--workspace-row-bg)] p-3">
                    <p className="text-sm font-normal text-[color:var(--workspace-text)]">{active.name}</p>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="rounded-md border border-[color:var(--workspace-row-border)] bg-[var(--workspace-row-bg)] p-2">
                      <p className="text-[11px] text-[color:var(--app-text-subtle)]">{t('newbuild.newBuildingsPartnersPage.сделки_ytd')}</p>
                      <p className="mt-1 text-lg font-normal text-emerald-300">{active.dealsYtd}</p>
                    </div>
                    <div className="rounded-md border border-[color:var(--workspace-row-border)] bg-[var(--workspace-row-bg)] p-2">
                      <p className="text-[11px] text-[color:var(--app-text-subtle)]">{t('newbuild.newBuildingsPartnersPage.регистрации_ytd')}</p>
                      <p className="mt-1 text-lg font-normal text-blue-300">{active.regYtd}</p>
                    </div>
                  </div>
                  <div className="grid grid-cols-1 gap-2">
                    <div className="rounded-md border border-[color:var(--workspace-row-border)] bg-[var(--workspace-row-bg)] p-2">
                      <p className="text-[11px] text-[color:var(--app-text-subtle)]">{t('newbuild.newBuildingsPartnersPage.ответственный')}</p>
                      <p className="mt-1 text-sm font-normal text-[color:var(--workspace-text)]">{active.manager}</p>
                    </div>
                    <div className="rounded-md border border-[color:var(--workspace-row-border)] bg-[var(--workspace-row-bg)] p-2">
                      <p className="flex items-center gap-1 text-[11px] text-[color:var(--app-text-subtle)]">
                        <Phone className="size-3.5" />
                        {t('newbuild.newBuildingsPartnersPage.контакт')}</p>
                      <p className="mt-1 text-sm font-normal text-[color:var(--workspace-text)]">{active.phone}</p>
                    </div>
                    <div className="rounded-md border border-[color:var(--workspace-row-border)] bg-[var(--workspace-row-bg)] p-2">
                      <p className="text-[11px] text-[color:var(--app-text-subtle)]">{t('newbuild.newBuildingsPartnersPage.проекты_в_работе')}</p>
          ...
          <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
            <section className="rounded-lg border border-[var(--hub-card-border)] bg-[var(--hub-card-bg)] p-3">
              <div className="mb-2 flex items-center gap-2">
                ...
                <h2 className="text-sm font-normal text-[color:var(--theme-accent-heading)]">{t('newbuild.newBuildingsPartnersPage.низкий_индекс')}</h2>
              </div>
              <ul className="space-y-2">
                {atRisk.map((p) => (
                  ...
                  >
                    {p.name} {t('newbuild.newBuildingsPartnersPage.индекс')}{p.health} {t('newbuild.newBuildingsPartnersPage.сделок')}{p.dealsYtd}
                  </li>
                ))}
              </ul>
            </section>
            <section className="rounded-lg border border-[var(--hub-card-border)] bg-[var(--hub-card-bg)] p-3">
              <div className="mb-2 flex items-center gap-2">
                ...
                <h2 className="text-sm font-normal text-[color:var(--theme-accent-heading)]">{t('newbuild.newBuildingsPartnersPage.топ_по_сделкам')}</h2>
              </div>
              <ul className="space-y-2">
                {[...PRIMARY_PARTNERS]
