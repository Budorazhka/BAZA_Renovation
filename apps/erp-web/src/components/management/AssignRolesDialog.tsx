  ...
  return (
    <>
        ...
        >
          <div className="flex flex-col min-h-[70vh] max-h-[90vh]">
            ...
            <div className="flex items-center justify-between gap-2 px-4 py-3 border-b border-slate-100 bg-slate-50/50 shrink-0">
              ...
              >
                {t('management.assignRolesDialog.отмена')}</button>
              <DialogHeader className="flex-1 min-w-0 py-0 px-1">
                <DialogTitle className="flex items-center justify-center gap-1.5 text-base font-normal text-slate-900">
                  <Shield className="size-4 text-sky-500 shrink-0" />
                  <span className="truncate">{t('management.assignRolesDialog.доступы')}</span>
                </DialogTitle>
              ...
              <button
                ...
                onClick={() => onOpenChange(false)}
                aria-label={t('management.assignRolesDialog.закрыть')}
              >
                <X className="size-5" />
              </button>
            </div>
            ...
            <ScrollArea className="flex-1 min-h-0">
              ...
              <div className="px-3 pt-3 pb-1">
                <p className="text-[11px] uppercase tracking-wider text-slate-400 font-medium px-1 mb-2">
                  {t('management.assignRolesDialog.роли')}</p>
              ...
              <div className="px-3 pt-4 pb-4">
                <p className="text-[11px] uppercase tracking-wider text-slate-400 font-medium px-1 mb-2">
                  {t('management.assignRolesDialog.права_доступа')}</p>
                <div className="rounded-xl border border-slate-200/80 bg-white overflow-hidden">
      ...
      <ConfirmationDialog
        ...
        title={t('management.assignRolesDialog.подтвердите_изменени')}
        description={t('management.assignRolesDialog.вы_уверены_это_измен')}
