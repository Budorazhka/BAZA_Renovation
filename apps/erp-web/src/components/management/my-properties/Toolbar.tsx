    ...
    <div className="flex flex-wrap items-center gap-2.5">
      ...
      <div className="relative min-w-[220px] flex-1 max-w-xs">
        ...
        <input
          ...
          placeholder={t('management.my-properties.toolbar.название_адрес_или_п')}
      ...
      >
        ...
        {t('management.my-properties.toolbar.фильтры')}{activeFiltersCount > 0 && (
          <span className="flex size-4 items-center justify-center rounded-full bg-[var(--gold)] text-[10px] font-normal text-[color:var(--gold-btn-text)]">
            {activeFiltersCount}
          </span>
        )}
      </button>
