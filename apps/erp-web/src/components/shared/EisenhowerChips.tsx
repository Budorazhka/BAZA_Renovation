    ...
    <div className="flex flex-wrap items-center gap-2">
      <div className={cn('flex rounded-lg overflow-hidden border', styles.group)}>
        ...
        >
          ...
          {t('shared.eisenhowerChips.срочно')}</button>
        <button
          type="button"
        ...
        >
          ...
          {t('shared.eisenhowerChips.не_срочно')}</button>
      </div>
      <div className={cn('flex rounded-lg overflow-hidden border', styles.group)}>
        <button
          type="button"
        ...
        >
          ...
          {t('shared.eisenhowerChips.важно')}</button>
        <button
          type="button"
        ...
        >
          ...
          {t('shared.eisenhowerChips.не_важно')}</button>
      </div>
    </div>
  )
}
