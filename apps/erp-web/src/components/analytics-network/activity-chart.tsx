...
const legendItems = [
    { key: "calls", label: "Звонки", color: "#c58b2e" },
    { key: "chats", label: "Чаты", color: "#24a6b8" },
    { key: "selections", label: "Рассылки", color: "#8f72c9" },
];
        ...
        <Card className="w-full">
            <CardHeader className="px-4 pb-2 pt-4">
                <div className="flex flex-col gap-3">
                    <CardTitle className="text-center text-lg font-normal text-slate-900 sm:text-xl">{t('analytics-network.activity-chart.активность')}</CardTitle>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        <div className="flex items-center gap-1">
                            <span className="text-4xl font-normal leading-none text-slate-900">{totalActivity.toLocaleString("ru-RU")}</span>
                            <span className="mb-1 self-end text-base text-slate-700">{t('analytics-network.activity-chart.действий')}</span>
                        </div>
