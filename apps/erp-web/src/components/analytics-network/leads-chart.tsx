        ...
        <Card className="w-full">
            <CardHeader className="px-4 pb-2 pt-4">
                <div className="flex flex-col items-center gap-2">
                    <CardTitle className="text-center text-lg font-normal text-slate-900 sm:text-xl">{t('analytics-network.leads-chart.динамика_лидов')}</CardTitle>
                ...
                <div className="mt-1 text-center">
                    <span className="text-4xl font-normal leading-none text-slate-900">{totalLeads.toLocaleString("ru-RU")}</span>
                </div>
            </CardHeader>
                    ...
                    <AreaChart accessibilityLayer data={data} margin={{ left: 0, right: 0, top: 0, bottom: 0 }}>
                        <defs>
                            <linearGradient id="leadsGradient" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="5%" stopColor="#24a6b8" stopOpacity={0.36} />
                                <stop offset="95%" stopColor="#24a6b8" stopOpacity={0.04} />
                            </linearGradient>
                        </defs>
                        <CartesianGrid
                            vertical={false}
