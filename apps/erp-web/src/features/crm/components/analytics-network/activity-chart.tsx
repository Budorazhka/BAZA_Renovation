        ...
        <Card className="w-full">
            <CardHeader className="px-4 pb-2 pt-3">
                <div className="flex flex-col gap-3">
                    <CardTitle className="text-center text-base">{t('crm.analytics-network.activity-chart.активность')}</CardTitle>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        <div className="flex items-center gap-1">
                            ...
                            <span className="text-xs text-muted-foreground self-end mb-1">{t('crm.analytics-network.activity-chart.действий')}</span>
                        </div>
