...
describe('IsPolygonConstraint', () => {
  ...
  it.each([
    ...
    ['ровно 200 точек (400 чисел) — верхняя граница', Array.from({ length: 400 }, (_, i) => (i % 2 === 0 ? 44 : 41)).join(',')],
  ...
  it.each([
    ...
    ['пустая строка', ''],
    ['больше 200 точек (401 число)', Array.from({ length: 401 }, (_, i) => (i % 2 === 0 ? 44 : 41)).join(',')],
