...
> Актуализация 07.09.2026: полный объём этого плана сохранён. Текущее состояние —
> [сверка 07.09](progress-report-2026-09-07.md), выбранная очередь —
> [завершение первички](codex/plans/2026-09-07-primary-sales-completion.md).
> Датированные снимки ниже исторические и не описывают текущее отсутствие функций.
...
**07.09.2026 — очередь исполнения:** по поручению владельца выбрать задачи
выбран этап 7 (завершение продаж первички) с P0-проверками контрактов,
конкурентности и ERP, затем приёмка UI и пилота. Детализация — в текущем плане.
Это выбор порядка работ, не сокращение полного scope и не утверждение тарифов,
рассрочек или правил закрепления клиента. P0-01 закрыта локальным quality gate 07.09 (55/55 задач без кеша); остальные восемь открыты. См. [результат P0-01](operations/p0-01-contract-quality-gate.md).
...
## 18. Где актуальное состояние (добавлено 11.09.2026)

Разделы 14–17 — исторические снимки 25–31.08. Их список «Not started» и оценки охвата устарели: с тех пор сделаны брони, подборки агента, админка и первичка, начаты этапы 9–11. Текущее состояние ведётся в датированных сверках `docs/progress-report-*.md` (последняя — [11.09.2026](progress-report-2026-09-11.md)), очередь — в [roadmap-2026-09.md](roadmap-2026-09.md). Этот документ остаётся источником объёма работ и решений владельца; этапы 9–11 начаты вне очереди, без записи в журнале решений (раздел 13) и без передачи по §12.4.
