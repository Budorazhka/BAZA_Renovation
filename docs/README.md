...
- [billing-manual-subscriptions.md](operations/billing-manual-subscriptions.md) — тарифы, подписка, журнал, ручная активация админом с грантом; с 11.09 обзор биллинга в админке тоже требует гранта (`manual_ledger.read`), первая подписка получает trial-план своего типа организации (не всегда agency); лимиты и заморозка пока ничего не ограничивают.
